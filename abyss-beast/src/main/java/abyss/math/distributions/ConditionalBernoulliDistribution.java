package abyss.math.distributions;
...
//TODO Add conditions to ensure at least one cycle in final matrix

/**
 * Added from BEASTLabs
 * @author Alexei Drummond
 */
@Description("Bernoulli distribution, used as prior or likelihood." +
        "If the input x is a multidimensional parameter, each of the dimensions is considered as a " +
        "separate independent component.")
public class ConditionalBernoulliDistribution extends Distribution {
